...
Authors: David Mutchler, Vibha Alangar, Dave Fisher, Amanda Stouder,
         their colleagues and Rachael Enrici.
...
# TOD (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
# TOO (continued): Then implement a class called   Point that has NO METHODS
# TDO (continued)  yet, just the lines that start the definition of any class:
#
...
class Point(object):
    ...
    def move_to(self, x, y):
        self.distanceTraveled = self.distanceTraveled + ((x - self.x) ** 2 + (y - self.y) ** 2) ** (1 / 2)
        self.x = x
        self.y = y
        self.move = self.move + 1

    def move_by(self, dx, dy):
        self.distanceTraveled = self.distanceTraveled + ((dx) ** 2 + (dy) ** 2) ** (1 / 2)
        self.x = self.x + dx
        self.y = self.y + dy
        self.move = self.move + 1
    ...
    def get_distance_from_start(self):
        return (((self.xstart - self.x) ** 2 + (self.ystart - self.y) ** 2) ** (1 / 2))
...
def run_test_repr():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 4.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_clone():
   ...
   """
    # -------------------------------------------------------------------------
    # DO: 5.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_to():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 6.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # -------------------------------------------------------------------------
    # TO: 7.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 8.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 9.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 10.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 11.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 12.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # -------------------------------------------------------------------------
    # DO: 13.  Follow the same instructions as in TO-DO 3 above,
